...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserSettings&&(identical(other.appTheme, appTheme) || other.appTheme == appTheme));
}
...
@override
String toString() {
  return 'UserSettings(appTheme: $appTheme)';
}
...
/// Create a copy of UserSettings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? appTheme = null,}) {
...
class _UserSettings implements UserSettings {
  const _UserSettings({required this.appTheme});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UserSettings&&(identical(other.appTheme, appTheme) || other.appTheme == appTheme));
}
...
/// Create a copy of UserSettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? appTheme = null,}) {
